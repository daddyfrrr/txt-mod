...
AUTH_USER = os.environ.get('AUTH_USERS', '7877249692').split(',')
...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/daddyfrrr"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+Bc5r4pIjqkczMWVl"),
        ],
    ]
)
...
async def txt_handler(bot: Client, m: Message):  
    ...
    if raw_text3 == '1':
        CR = '[𝗩𝗔𝗥𝗦𝗛𝗜𝗡𝗜](https://t.me/varshini3bot)'
    else:
        CR = raw_text3
        ...
        for i in range(arg-1, len(links)):
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    try:
                        BUTTONSZIP= InlineKeyboardMarkup([[InlineKeyboardButton(text="🎥 STREAM IN PLAYER", url=f"{url}")]])
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [ᴍʀ. ꜱᴛᴜᴅᴇɴᴛ](https://t.me/daddyfrrr)"
